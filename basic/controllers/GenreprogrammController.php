...
class GenreprogrammController extends ActiveController
{
    ...
    /**
     * Lists all GenreProgramm models.
     * @return mixed
     */
    ...
    /**
     * Displays a single GenreProgramm model.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Creates a new GenreProgramm model.
    ...
    /**
     * Updates an existing GenreProgramm model.
    ...
    /**
     * Deletes an existing GenreProgramm model.
    ...
    /**
     * Finds the GenreProgramm model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return GenreProgramm the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
