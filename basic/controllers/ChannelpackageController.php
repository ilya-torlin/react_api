...
use app\models\ChannelpackageSearch;
 ...
 */
class ChannelpackageController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $searchModel = new ChannelpackageSearch();
    ...
    {
        if (($model = Channelpackage::findOne($id)) !== null) {
            return $model;
        }
